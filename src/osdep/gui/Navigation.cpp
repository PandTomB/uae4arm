...
// main_window
  ...
  { "Hard drives / CD", "cmdCreateHDF",   "cmdAddDir",      "Floppy drives",    "Hardware info" },
  { "Hardware info",    "",               "",               "Hard drives / CD", "Display" },
  { "Display",          "sldWidth",       "sldWidth",       "Hardware info",    "Sound" },
...
// PanelCPU
  ...
  { "CPUComp",        "CPU and FPU",    "FPUJIT",         "CPU24Bit",       "CPUCE" },
  { "CPUCE",          "CPU and FPU",    "FPUJIT",         "CPUComp",        "JIT" },
  { "JIT",            "CPU and FPU",    "FPUJIT",         "CPUCE",          "Cachemem" },
  { "Cachemem",       "",               "",               "JIT",            "68000" },
...
//PanelFloppy
  ...
  { "cmdEject0",      "cmdInfo0",       "cmdSel0",        "CreateHD",       "cboDisk0" },
  ...
  { "cboType3",       "DF3:",           "chkWP3",         "boDisk2",       "cboDisk3" },
