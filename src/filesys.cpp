...
void uci_set_defaults (struct uaedev_config_info *uci)
{
...
static int filesys_insert (int nr, const TCHAR *volume, const TCHAR *rootdir, bool readonly, int flags)
{
  UnitInfo *ui;
  Unit *u;
...
static TCHAR *new_filesys_root_path;
